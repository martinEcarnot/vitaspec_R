...
```{r}
list_pre=list(rbind(list('adj',''),list('red',c(950,750,1)),list('snv',''),list('sder',c(1,3,15))),
...
matplot(r2_tt, type = 'l', lty = 1, col = 1:ncol(r2_tt), ylab="R2_Validation_Croisée", xlab="Nombre de Variable Latentes") 
title(ag1)
...
param <- tribble(
  ...
  "C16.0",        rbind(list('adj',''),list('red',c(950,750,1)),list('snv',''),list('sder',c(2,3,15))),9,
  "C18.0",        rbind(list('adj',''),list('snv',''),list('sder',c(2,3,15))),                          21,
  "C18.1n9",      rbind(list('adj',''),list('red',c(950,750,1)),list('snv',''),list('sder',c(2,3,15))), 11,
  "C18.2",        rbind(list('adj',''),list('red',c(950,750,1)),list('snv',''),list('sder',c(1,3,15))),11,
  "alpha.carotene", rbind(list('adj',''),list('red',c(1,1900,1)),list('snv','')),                       4,
  "beta.carotene", rbind(list('adj',''),list('red',c(1,1900,1)),list('snv','')),                        4,
  "aT",           rbind(list('adj',''),list('snv',''),list('sder',c(2,3,15))),                          16,
  "aT3",          rbind(list('adj',''),list('red',c(1,1200,1)),list('snv',''),list('sder',c(2,3,51))),17,
  "gT3",          rbind(list('adj',''),list('snv',''),list('sder',c(2,3,15))),                         18,
  "dT3",          rbind(list('adj',''),list('red',c(1,1300,1)),list('snv','')),                        16,
  "TOTAL_TOCO",   rbind(list('adj',''),list('red',c(1,1200,1)),list('snv',''),list('sder',c(2,3,51))),17,
  "TOTAL_T3",     rbind(list('adj',''),list('red',c(1,1200,1)),list('snv',''),list('sder',c(2,3,51))),16,
  ...
  "carotenes",    rbind(list('adj',''),list('snv',''),list('sder',c(2,3,15))),                        4
)
