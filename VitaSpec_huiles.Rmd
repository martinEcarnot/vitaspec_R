...
vitaspec_load=function(d0) {
  #d=paste0("~/Documents/INRA/Projets/VitaSPEC/",d0)
  d=paste0("C:/Users/guest/Documents/Martin/VitaSPEC/",d0)
  sp=asd_read_dir(d)
  sp=sp2df(sp)
  colnames(sp)[1]=paste0("x",sub(".*_(.*)$", "\\1", d0))
  sp$ech=substr(rownames(sp$x),1,nchar(rownames(sp$x))-5)
  sp$spname=rownames(sp$x)
  return(sp)
}
  
spAD=merge(vitaspec_load("20240424_VitaSPEC_HR_AGAP"),vitaspec_load("20240424_VitaSPEC_HR_DIADE"),by="spname")
