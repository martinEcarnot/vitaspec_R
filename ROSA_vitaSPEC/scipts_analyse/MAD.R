...
HR_25_DIADE <- read.csv(paste0(d0,"vitaspec_R/ROSA_vitaSPEC/Data/X/HR_25_DIADE.csv"))

HR_pred <- readxl::read_excel(paste0(d0,"vitaspec_R/ROSA_vitaSPEC/predictions/old_mauvais_param/HR_pred.xlsx")) %>% 
  mutate(
